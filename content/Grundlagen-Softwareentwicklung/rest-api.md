...
Der Client- und die Serveranwendung sind unabhängig von einander. Der Client stellt eine Anfrage in seiner Sprache an den Server. Der Server Natwortet dann in einen Format wie z.B. JSON oder XML.
